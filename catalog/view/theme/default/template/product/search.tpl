...
<div class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      <label class="control-label" for="input-search"><?php echo $entry_search; ?> (<?php echo $heading_title; ?>)</label>
      <div class="row">
        <div class="col-sm-4">
        ...
        <input type="button" value="<?php echo $button_search; ?>" id="button-search2" class="btn btn-primary" />  
      </div>

      <div class="row" style="margin-top: 35px">
          <div class="col-sm-12 text-center">
            <h4 class="general_title"><?php echo $text_search; ?></h4>
          </div>
        </div>
      <?php if ($products) { ?>
      <div class="row">
